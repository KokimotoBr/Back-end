...
'Break'
// break interrompe o laço de repetição e continua o que tiver fora do laço

'Continue'

//No while ele volta pra condição
//No for ele pula pro pra proxima implementação
...
for (let index = 0; index < Array.length; index++) { // só vai parar de repetir, até o index ser maior que o array
...
for (let dados in aluno) {  //for in para objetos
    console.log(aluno{dados});  //Ele segue cada propriedade seguindo a ordem que foram declaradas
}

//For of

let clientes_array = [
    { id: 1, nome: "Monica", telefone: "12345-12345" },
    { id: 2, nome: "Jonas", telefone: "67890-67890" },
    { id: 3, nome: "Helmert", telefone: "12345-67890" },
];
